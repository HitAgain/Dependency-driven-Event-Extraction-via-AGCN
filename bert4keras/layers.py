...
class GraphLayer(Layer):
    ...
    def __init__(
        ...
        only_return_attention_scores=False,
        ...
        **kwargs
        ...
        self.only_return_attention_scores = only_return_attention_scores
    ...
    def call(self, inputs, mask=None, **kwargs):
        ...
        if self.return_attention_scores:
            return [o, a]
        elif self.only_return_attention_scores:
            return a
        else:
            return o
    ...
    def get_config(self):
        config = {
            ...
            'only_return_attention_scores': self.only_return_attention_scores,
            'kernel_initializer':
